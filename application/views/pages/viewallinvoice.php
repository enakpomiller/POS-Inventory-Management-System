        ...
        <div class="card card-statistics h-100 mb-0">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-4">
                <button class="w-100 btn-primary pt-2 pb-2"><i class="fa fa-filter"></i>-Filter </button>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <tbody>
                      <?php  $counter =1; foreach ($articles as $article): ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?=base_url('products/viewcustinvoice/'.$article->customerID)?>" class="btn btn-info  pr-2 pl-2" title="view Record"> <i class='fa fa-eye'></i> </a>
